...
from translateByDeepl import Translator  # 実際のファイル名に合わせて変更
import deepl
import os
...
class TestTranslateText(unittest.TestCase):
    # 正常系：英語リストが正しく翻訳される 
    @patch('translateByDeepl.os.getenv', return_value='dummy_auth_key')
    @patch('translateByDeepl.deepl.Translator')
